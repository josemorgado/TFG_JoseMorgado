...
export default function PerfilDetail() {
    ...
    const iniciales = useMemo(() => {
        ...
        return letras.join("") || (usuario.username?.slice(0, 2).toUpperCase() ?? "");
        }
...
<div className="perfil-info-header">
  <h2 className="perfil-title">Perfil de: <strong>{usuario.username}</strong></h2>
</div>

    <div className="perfil-data">

                <p className="perfil-data-fields"><strong>Nombre:</strong> {usuario.first_name} {usuario.last_name}</p>
                <p className="perfil-data-fields"><strong>Edad:</strong> {usuario.perfil.edad}</p>
                <p className="perfil-data-fields"><strong>Descripcion:</strong> {usuario.perfil.biografia}</p>
                <p className="perfil-data-fields"><strong>Activo desde:</strong> {usuario.date_joined}</p>
